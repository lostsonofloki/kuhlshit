/**
 * Scrape https://www.huey-music.com/ (home + key pages) with Playwright.
 *
 * Usage:
 *   node scripts/scrape-huey-music.mjs
 *   OUT=tmp/huey-music.json node scripts/scrape-huey-music.mjs
 */
...
const SITE = 'https://www.huey-music.com'
