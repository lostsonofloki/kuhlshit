  ...
  return (
    <div className="artist-detail-page">
      ...
      <div className="artist-content">
        ...
        {/* Music Links */}
        {artist.musicLinks && (artist.musicLinks.spotify || artist.musicLinks.appleMusic || artist.musicLinks.youtube || artist.musicLinks.amazonMusic || artist.musicLinks.shazam || artist.musicLinks.soundcloud || artist.musicLinks.bandcamp) && (
          <div className="artist-section">
            <h2>Listen</h2>
            <div className="music-links">
              ...
              {artist.musicLinks.soundcloud && (
                <a href={artist.musicLinks.soundcloud} target="_blank" rel="noopener noreferrer" className="music-link">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {artist.musicLinks.amazonMusic && (
                <a href={artist.musicLinks.amazonMusic} target="_blank" rel="noopener noreferrer" className="music-link">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {artist.musicLinks.shazam && (
                <a href={artist.musicLinks.shazam} target="_blank" rel="noopener noreferrer" className="music-link">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              {artist.musicLinks.bandcamp && (
                <a href={artist.musicLinks.bandcamp} target="_blank" rel="noopener noreferrer" className="music-link">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
